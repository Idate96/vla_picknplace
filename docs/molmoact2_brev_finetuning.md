...
This syncs the repo with rsync, installs FFmpeg shared libraries for LeRobot
video decoding, installs `uv`, creates `.venv`, installs LeRobot and
`requirements.txt`, checks imports, and prints visible GPUs.
